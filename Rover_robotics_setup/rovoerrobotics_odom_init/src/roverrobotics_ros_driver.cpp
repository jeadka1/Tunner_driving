...
//    robot_pose_from_linearvel_publisher_ = nh->advertise<geometry_msgs::Point>("linear_vel_pose", 1);
    //
...
void RobotDriver::publishOdometry(const ros::TimerEvent &event) {
    ...
    //pcw for QR local
    static double dt_x_by_linearvel = 0;
    static double dt_y_by_linearvel = 0;
    //
    ...
    //pcw for QR local
    dt_x_by_linearvel = dt_x_by_linearvel+  data.linear_vel *dt;
    //
...
//                theta += 2*3.141592;
    ...
    //pcw for QR local
//    geometry_msgs::Point linearvel_pose_msg;
//    linearvel_pose_msg.x = dt_x_by_linearvel;
//    linearvel_pose_msg.y = dt_y_by_linearvel;
//    robot_pose_from_linearvel_publisher_.publish(linearvel_pose_msg);
}
